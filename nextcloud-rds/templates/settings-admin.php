...
<div id="rdsSettings" class="section">
    ...
    <form id="rds-settings">
        <p>
            <input type="text" name="cloudURL" id="cloud_url" class="text" <?php if (!empty($_["cloudURL"])) { ?> value="<?php print_unescaped($_['cloudURL']); ?>" <?php } ?> placeholder="<?php p($l->t('url to rds instance')); ?>" style="width: auto !important" />
            <label for="cloudURL">
        ...
        <p>
            <input type="text" name="oauthname" id="oauth_name" class="text" <?php if (!empty($_["oauthname"])) { ?> value="<?php print_unescaped($_['oauthname']); ?>" <?php } ?> placeholder="<?php p($l->t('name of oauth credentials')); ?>" style="width: auto !important" />
            <label for="oauthname">
